...
SELECT *
FROM CUSTOMER
WHERE EXTRACT(YEAR FROM BIRTHDATE) < 1995 AND EXTRACT(YEAR FROM BIRTHDATE) > 1985 ;
...
-- 이름, 생년월일, 나이 정보 조회
SELECT NAME, BIRTHDATE, EXTRACT(YEAR FROM SYSDATE) - EXTRACT(YEAR FROM BIRTHDATE) + 1 "나이"
FROM CUSTOMER;