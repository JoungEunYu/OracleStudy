...
INSERT INTO EMPLOYEE
    VALUES(300, '양민욱', '930806-1000000', 'minwook@or.kr', '01012345678', 'D4', 'J4', 3000000, 0.3, NULL, SYSDATE, NULL, 'N');
...
/*
  2) INSERT INTO 테이블명(컬럼명, 컬럼명, 컬럼명) VALUES(값, 값, 값)
        ...
        => NOT NULL 제약조건이 있는 컬럼의 경우 직접 컬럼을 제시하여 값을 추가하거나,
            DEFAULT 옵션을 설정해야함 (그렇지 않으면 오류발생)
*/
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, EMAIL, JOB_CODE)
    VALUES (301, '양준혁', '000501-3000000', 'junhyeok2@or.kr', 'J3');
--------------------------------------------------------------------------------
/*
...
/*
    ...
    : 두개 이상의 테이블에 각각 데이터를 추가할 때 사용
     이떄 사용되는 서브쿼리가 동일한 경우
*/
-- 사번, 사원명, 부서코드, 입사일 정보를 가지는 테이블
CREATE TABLE EMP_DEPT
AS ( SELECT EMP_ID, EMP_NAME, DEPT_CODE, HIRE_DATE
     FROM EMPLOYEE
     WHERE 1 = 0);  -- 1 = 0 -> FALSE 의미없음
...
-- 대북혼 사원의 급여를 500만원으로 변경
UPDATE EMP_TABLE
    SET SALARY = 5000000,
        BONUS = 0.2
    WHERE EMP_NAME = '대북혼';
    
-- 전체 사원의 급여를 기존 급여에 10프로 인상 (기존 급여 * 1.1)
UPDATE EMP_TABLE
