/*
    * 트리거 (TRIGGER)
    ...
    ex) 신고횟수가 특정 값을 넘어 갔을 떄 해당 회원을 블랙리스트 처리
    
    ex) 입출고에 대한 데이터를 기록할 때 해당 상품의 재고 수량을 갱신해야 할 떄
*/
/*
    * 트리거의 종류 *
...
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, DEPT_CODE, JOB_CODE, HIRE_DATE)
    VALUES(500, '정은유', '990224-1111111', 'D4', 'J4', SYSDATE);
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, DEPT_CODE, JOB_CODE, HIRE_DATE)
    VALUES(501, '정은유1', '290224-1111111', 'D4', 'J4', SYSDATE);
-------------------------------------------------------------------------------
-- 상품 입고 및 출고 관련
...
--------------------------------------------------------------------------------
/*
    TB_PDETAIL (입출고이력) 테이블에 테이터 추가(INSERT) 이벤트 발생 시 
    TB_PRODUCT (상품) 테이블에 재고 수량이 갱싱 (UPDATE) 되어야 함 = > 자동처리할 수 있도록 트리거 생성
