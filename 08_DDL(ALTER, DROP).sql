...
*/
-- DEPT_TABLE 테이블에  NCAME VARCHAR2(20) 컬럼 추가
ALTER TABLE DEPT_TABLE ADD NCAME VARCHAR2(20);
...
-- 숫자타입으로 변경
ALTER TABLE DEPT_TABLE MODIFY DEPT_ID NUMBER; --> 형식 오류 발생 (기존 : 문자타입, 변경 : 숫자타입) 불가능
...
/*
    ...
    ALTER TABLE 테이블명 MODIFY 컬럼명 NULL; -- 다시 NULL로 바꿔줌
*/
ALTER TABLE DEPT_TABLE DROP CONSTRAINT SYS_C008511;
ALTER TABLE DEPT_TABLE DROP CONSTRAINT SYS_C008512
                       MODIFY LNAME NULL;
---------------------------------------------------------------------------------
-- 테이블 삭제
-- DROP TABLE 테이블 명
...
-- 2) 제약 조건명 변경 : RENAME CONSTRAINT 기존제약조건명 TO 바꿀제약조건명
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C008513 TO DT_DEPTID_NN;
