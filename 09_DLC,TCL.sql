...
/*
    ...
    - RESOURCE : 지원관리(특정 객체 생성 권한) (CREATE TABLE, CREATE SEQUENCE, ...)
*/
-- 롤 정보를 조회
...
/*
    ...
    * 트랜잭션 종류
        ...
        - SAVEPOINT : 현재 시점에 변경사항들을 임시로 저장해두는 것을 의미
                        ROLLBACK 시 전체 변경 사항을 모두 삭제하지 않고 해당 위치까지만 취소 가능
*/
-- EMP01 테이블 삭제
DROP TABLE EMP01;  --> DDL. 트랜잭션 처리 X, DDL은 무조건 커밋

-- EMP01 테이블을 복제생성 (EMPLOYEE 테이블에서 사번, 사원명, 부서명을 조회)
CREATE TABLE EMP01
